...
How to cut a public Noctaxris-GCP release (example: **1.3.0**). Docker Hub image: **`kyaxris/noctaxris-gcp`**.
...
git tag -a v1.3.0 -m "Release Noctaxris-GCP 1.3.0"
...
| Tag | Meaning |
|-----|---------|
| `kyaxris/noctaxris-gcp:1.3.0` | Exact semver |
| `kyaxris/noctaxris-gcp:1.3` | Major.minor |
...
```bash
docker build -f docker/Dockerfile --build-arg VERSION=1.3.0 -t kyaxris/noctaxris-gcp:local .
